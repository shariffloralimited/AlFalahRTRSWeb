                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <div style="width: 100%; overflow: auto">
                                    <asp:DataGrid ID="SearchGrid" runat="server" AutoGenerateColumns="false" FooterStyle-Font-Bold="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="CBS_N" HeaderText="CBS_N" />
                                            <asp:BoundColumn DataField="CBSResponse" HeaderText="T24 Response" />
                                            <asp:BoundColumn DataField="CBS_R" HeaderText="CBS_R" />
                                            <asp:BoundColumn DataField="CBSResponseR" HeaderText="T24 Ret Response" />
                                        </Columns>
                                    </asp:DataGrid>
                                </div>
                            </div>
                                ...
                                <div style="width: 100%; overflow: auto">
                                    <asp:DataGrid ID="SearchGrid" runat="server" AutoGenerateColumns="false" FooterStyle-Font-Bold="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="FormName" HeaderText="Trans Type" />
                                            <asp:BoundColumn DataField="BankBIC" HeaderText="Bank" />
                                            <asp:BoundColumn DataField="ToBranch" HeaderText="Opposite Branch" />
                                            <asp:BoundColumn DataField="Branch" HeaderText="Branch" />
                                            <asp:BoundColumn DataField="DeptName" HeaderText="Dept" />
                                            <%--<asp:BoundColumn DataField="SttlmAmt" HeaderText="Amount" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right" />--%>
                                            <asp:BoundColumn DataField="SttlmAmt" HeaderText="Amount" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
                                            <asp:BoundColumn DataField="Ccy" HeaderText="Currency" />
                                            <asp:BoundColumn DataField="DbtrNm" HeaderText="Sender Name" />
                                            <asp:BoundColumn DataField="DbtrAcctId" HeaderText="Sender A/C Number" />
                                            <asp:BoundColumn DataField="CdtrNm" HeaderText="Receiver Name" />
                                            <asp:BoundColumn DataField="CdtrAcctId" HeaderText="Receiver A/C Number" />
                                            <asp:BoundColumn DataField="StatusName" HeaderText="Status" />
                                            <asp:BoundColumn DataField="RtrRsnAddtlInf" HeaderText="Narrations" />
