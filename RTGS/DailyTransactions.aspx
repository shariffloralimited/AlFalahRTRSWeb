                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <table border="0">
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlDay" Width="70px" CssClass="form-control" runat="server">
                            ...
                            <div class="col-md-3">
                                <ul class="list-inline">
                                    <li>
                                        <asp:LinkButton ID="BtnRun" CssClass="btn btn-success" runat="server" Text="Go"></asp:LinkButton></li>
                                    <li>
                                    ...
                                    <div style="width: 100%; overflow: auto">
                                        <asp:DataGrid ID="BatchChecksGrid" runat="server" AutoGenerateColumns="false" FooterStyle-Font-Bold="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="CBS_N" HeaderStyle-BackColor="#c0c0c0" HeaderText="CBS_N" ItemStyle-Wrap="false" />
                                                <asp:BoundColumn DataField="CBSResponse" HeaderStyle-BackColor="#c0c0c0" HeaderText="T24 Response" ItemStyle-Wrap="false" />
                                                <asp:BoundColumn DataField="BranchCode" HeaderStyle-BackColor="#c0c0c0" HeaderText="Branch Code" ItemStyle-Wrap="false" />
                                                <%--<asp:BoundColumn DataField="CBS_R" HeaderStyle-BackColor="#c0c0c0" HeaderText="CBS_R" ItemStyle-Wrap="false" />
                                                <asp:BoundColumn DataField="CBSResponseR" HeaderStyle-BackColor="#c0c0c0" HeaderText="T24 Ret Response" ItemStyle-Wrap="false" />--%>
                                            </Columns>
                                        </asp:DataGrid>
                                    </div>
                                </div>
